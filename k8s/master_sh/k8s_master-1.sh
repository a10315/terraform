...
export MASTER_TOKEN_1=$(kubeadm token create --print-join-command)
aws ssm put-parameter --region ap-northeast-1 --name "MASTER_TOKEN_1" --value "$MASTER_TOKEN_1" --type String --overwrite
