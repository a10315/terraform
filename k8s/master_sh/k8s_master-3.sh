...
export MASTER_TOKEN_3=$(kubeadm token create --print-join-command)
aws ssm put-parameter --region ap-northeast-1 --name "MASTER_TOKEN_3" --value "$MASTER_TOKEN_3" --type String --overwrite
