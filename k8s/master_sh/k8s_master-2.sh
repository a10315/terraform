...
export MASTER_TOKEN_2=$(kubeadm token create --print-join-command)
aws ssm put-parameter --region ap-northeast-1 --name "MASTER_TOKEN_2" --value "$MASTER_TOKEN_2" --type String --overwrite
